				...
				<div class="wof-left-inner">
					...
					<div class="wof-wheel-container wof-spinning">
						...
						<?php foreach($model->slices as $slice) { ?>
							<div class="wof-slice" data-slice="<?php _e($ctr) ?>" style="-webkit-transform:rotate(<?php _e($start_degrees) ?>deg) translate(0px, -50%);transform:rotate(<?php _e($start_degrees) ?>deg) translate(0px, -50%);"><?php _e(wp_strip_all_tags($slice->label)); ?></div>
