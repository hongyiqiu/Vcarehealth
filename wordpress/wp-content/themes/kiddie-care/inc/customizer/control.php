...
class Kiddie_Care_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kiddie-care-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class Kiddie_Care_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Kiddie_Care_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Kiddie_Care_Note_Control extends WP_Customize_Control {
