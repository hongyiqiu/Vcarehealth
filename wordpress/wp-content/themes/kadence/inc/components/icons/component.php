...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		...
		switch ( $icon ) {
			case 'moon':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="kadence-svg-icon kadence-moon-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="https://www.w3.org/2000/svg">';
				if ( $display_title ) {
				...
				break;
			case 'sun':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="kadence-svg-icon kadence-sun-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="https://www.w3.org/2000/svg">';
				if ( $display_title ) {
